...
window.onscroll = function(){
    ...
    islam.style.fontSize = value + 'px';
    if(scrollY >= 67){
    islam.style.fontSize = 67 + 'px';
    islam.style.position = 'fixed';
    if(scrollY >= 400){
    ...
    if(scrollY >= 127){
        ...
        document.querySelector('.main').style.background = 'linear-gradient(#260031,#0e0116)'
    }
    } 
}
